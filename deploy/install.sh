...
# In case an earlier install added the watchdog timer, clean it up.
systemctl disable --now ariza-bot-watchdog.timer 2>/dev/null || true
rm -f /etc/systemd/system/ariza-bot-watchdog.service /etc/systemd/system/ariza-bot-watchdog.timer
