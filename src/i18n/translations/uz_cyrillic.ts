...
export const uz_cyrillic: Dict = {
  // common
  'cmd.start.greeting': '👋 Ассалому алайкум, <b>{name}</b>!\n\n📄 Бу бот суд учун расмий аризаларни бир дақиқада тайёрлаб беради — имзо ва санага тайёр, бепул.',
  'cmd.start.open_app': '🚀 Иловани очиш',
  'cmd.start.menu': 'Бошлаш учун менюдан танланг 👇',
  'cmd.about': '<b>ℹ️ Бот ҳақида</b>\n\n<b>ArizaPro</b> — Ўзбекистон судлари учун расмий ҳужжатларни бир неча дақиқада тайёрлаб берадиган бот ва мини-илова. Адвокатсиз, мустақил равишда: сиз оддий саволларга жавоб берасиз, бот эса тайёр ҳужжатни <b>PDF ёки Word</b> шаклида, 3 тилда тузиб беради.\n\n<b>🤖 Бот нима қила олади:</b>\n📄 <b>Ариза топшириш</b> — суд учун расмий ариза тайёрлаш (фуқаролик, жиноят, маъмурий, иқтисодий ишлар бўйича)\n📋 <b>Ишимни текшириш</b> — суд мажлислари жадвалини кўриш ва ўз ишингизни топиш\n🏛 <b>Судлар маълумоти</b> — ҳар бир суднинг манзили, телефони ва харитадаги жойлашуви\n📖 <b>Қўлланма</b> — қайси ариза қачон ва қаерга топширилишини тушунтиради\n\n🎙 Исм, манзил каби майдонларни <b>овозли хабар</b> билан ҳам юборсангиз бўлади — бот уни ўзи матнга айлантиради.\n\n💯 Хизмат тўлиқ <b>бепул</b>.\n\nСавол ёки таклифингиз борми? Қуйидаги тугма орқали боғланинг 👇',
  'about.support_btn': '💬 Қўллаб-қувватлаш',
  'about.channel_btn': '📢 Каналга ўтиш',
  ...
  'menu.scan': '📸 Ҳужжат сканери',
  'scan.cmd.desc': '📸 Ҳужжатни расмга олиб таҳлил қилиш',
  'scan.intro':
    '📸 <b>Ҳужжат сканери</b>\n\nИхтиёрий ҳужжатни (суд хабарномаси, қарор, жарима, шартнома, тилхат…) <b>расмга олиб юборинг</b> — мен уни ўқийман ва тушунтираман: бу нима, муддатлар қанча, нима қилиш керак.\n\n💡 Яхши ёруғликда, матн тўлиқ кўриниб турадиган қилиб суратга олинг.',
  'scan.thinking': '📸 Ҳужжатни ўқияпман…',
  'scan.error':
    '⚠️ Расмни таҳлил қилиб бўлмади. Ёруғроқ ва аниқроқ суратга олиб қайта юборинг.',
  'scan.disabled': 'ℹ️ Ҳужжат сканери ҳозирча мавжуд эмас.',
  ...
  'wiz.profile.prompt': '💾 Сақланган маълумотингиз — қўйиш учун босинг:',
  ...
  'bot.short_description':
    '⚖️ Ўзбекистон судлари учун расмий ҳужжатлар бир дақиқада. Ариза, суд жадвали, судлар маълумоти — бепул.',
  'bot.description':
    '⚖️ ArizaPro — Ўзбекистон судлари учун ёрдамчи. Адвокатсиз, мустақил равишда.\n\n🤖 Нима қила олади:\n📄 Расмий ариза тайёрлаш — фуқаролик, жиноят, маъмурий, иқтисодий ишлар бўйича\n📋 Суд мажлислари жадвалини текшириш ва ўз ишингизни топиш\n🏛 Барча судлар маълумотномаси: манзил, телефон, харита\n\n✨ Саволларга жавоб беринг — тайёр ҳужжат PDF ёки Word шаклида, 3 тилда.\n🎙 Овозли хабар ҳам қабул қилинади.\n\n{price_line}\n🌐 Кирилл / Lotin / Русский\n\n👇 «START» тугмасини босинг',
