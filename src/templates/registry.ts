...
/* ============================================================
 * 14i. JINOYAT — Шикоят ариза / Илтимоснома (жарима) шаблонлари.
 *      Тўртта алоҳида шаблон: жисмоний шахс ва ташкилот учун,
 *      ҳар бирида жарима камайтириш ёки муддат тиклаш.
 *
 * Shared field groups so the 4 templates stay DRY without any
 * runtime branching: each template hard-codes its applicant type.
 * ============================================================ */

/** Жарима тафсилотлари (Шикоят ариза учун). */
const JARIMA_DETAIL_FIELDS: FieldDef[] = [
  F.text(
    'penalty_org',
    L('🏛 Жарима солган орган', '🏛 Jarima solgan organ', '🏛 Орган, наложивший штраф'),
    L(
  ...
  NARRATIVE(
    'reason',
    L('📝 Камайтириш сабаби', "📝 Kamaytirish sababi", '📝 Причина для снижения'),
    L(
...
/** Муддат тиклаш тафсилотлари (Илтимоснома учун). */
const MUDDAT_DETAIL_FIELDS: FieldDef[] = [
  F.text(
    'penalty_org',
    L('🏛 Жарима солган орган', '🏛 Jarima solgan organ', '🏛 Орган, наложивший штраф'),
    L(
  ...
  F.text(
    'learned_where',
    L('📨 Қаердан/қандай олдингиз', '📨 Qayerdan/qanday oldingiz', '📨 Откуда/как получили'),
    L(
...
/** Жисмоний шахс маълумотлари. `withPhone` — Шикоятда Тел сатри бор. */
function indvApplicantFields(withPhone: boolean): FieldDef[] {
  ...
  if (withPhone) {
    fields.push(F.phone('plaintiff_phone', L('📱 Телефон', '📱 Telefon', '📱 Телефон')));
  }
  return fields;
}

/** Ташкилот маълумотлари. `withPhone` — Шикоятда Тел сатри бор. */
function orgApplicantFields(withPhone: boolean): FieldDef[] {
  const fields: FieldDef[] = [
    F.text(
      'plaintiff_org_name',
      L('🏢 Ташкилот номи', '🏢 Tashkilot nomi', '🏢 Название организации'),
      L('Масалан: «ХАЙРИЯТ» МЧЖ', 'Masalan: «XAYRIYAT» MCHJ', 'Например: ООО «ХАЙРИЯТ»'),
    ),
    F.fio('plaintiff_fio', L('👤 Раҳбар Ф.И.Ш.', '👤 Rahbar F.I.SH.', '👤 Ф.И.О. руководителя')),
  ];
  if (withPhone) {
    fields.push(F.phone('plaintiff_phone', L('📱 Телефон', '📱 Telefon', '📱 Телефон')));
  }
...
/* 1. Шикоят ариза — жаримани камайтириш (жисмоний шахс) */
const T_JIN_JARIMA: TemplateDef = {
  code: 'shikoyat-jinoyat-jarima',
  category: 'shikoyat',
  courtTypeCode: 'jinoyat',
  title: L('💸 Жаримани камайтириш', "💸 Jarimani kamaytirish", '💸 Уменьшение штрафа'),
  subtitle: L('жисмоний шахс учун', "jismoniy shaxs uchun", 'для физлица'),
  description: L('—', '—', '—'),
  instructions: JARIMA_INSTRUCTIONS,
  fileNameBase: 'shikoyat-jinoyat-jarima',
  fields: [...indvApplicantFields(true), ...JARIMA_DETAIL_FIELDS],
};

/* 2. Шикоят ариза — жаримани камайтириш (ташкилот) */
const T_JIN_JARIMA_ORG: TemplateDef = {
  code: 'shikoyat-jinoyat-jarima-org',
  category: 'shikoyat',
  courtTypeCode: 'jinoyat',
  title: L(
    '💸 Жаримани камайтириш (ташкилот)',
    "💸 Jarimani kamaytirish (tashkilot)",
    '💸 Уменьшение штрафа (организация)',
  ),
  subtitle: L('корхона/ташкилот учун', "korxona/tashkilot uchun", 'для организации'),
  description: L('—', '—', '—'),
  instructions: JARIMA_INSTRUCTIONS,
  fileNameBase: 'shikoyat-jinoyat-jarima-org',
  fields: [...orgApplicantFields(true), ...JARIMA_DETAIL_FIELDS],
};

/* 3. Илтимоснома — шикоят муддатини тиклаш (жисмоний шахс) */
const T_JIN_MUDDAT: TemplateDef = {
  code: 'iltimosnoma-jinoyat-muddat',
  category: 'iltimosnoma',
  courtTypeCode: 'jinoyat',
  title: L('⏳ Шикоят муддатини тиклаш', "⏳ Shikoyat muddatini tiklash", '⏳ Восстановить срок жалобы'),
  subtitle: L('жисмоний шахс учун', "jismoniy shaxs uchun", 'для физлица'),
  description: L('—', '—', '—'),
  instructions: MUDDAT_INSTRUCTIONS,
  fileNameBase: 'iltimosnoma-jinoyat-muddat',
  fields: [...indvApplicantFields(false), ...MUDDAT_DETAIL_FIELDS],
};

/* 4. Илтимоснома — шикоят муддатини тиклаш (ташкилот) */
const T_JIN_MUDDAT_ORG: TemplateDef = {
  code: 'iltimosnoma-jinoyat-muddat-org',
  category: 'iltimosnoma',
  courtTypeCode: 'jinoyat',
  title: L(
    '⏳ Шикоят муддатини тиклаш (ташкилот)',
    "⏳ Shikoyat muddatini tiklash (tashkilot)",
    '⏳ Восстановить срок жалобы (организация)',
  ),
  subtitle: L('корхона/ташкилот учун', "korxona/tashkilot uchun", 'для организации'),
  description: L('—', '—', '—'),
  instructions: MUDDAT_INSTRUCTIONS,
  fileNameBase: 'iltimosnoma-jinoyat-muddat-org',
  fields: [...orgApplicantFields(false), ...MUDDAT_DETAIL_FIELDS],
};
...
/* ============================================================
 * 14s. FUQAROLIK — маънавий зарар ундириш (moral damages claim)
 * ============================================================ */
const T_DAVO_MANAVIY_ZARAR: TemplateDef = {
  code: 'davo-ariza-manaviy-zarar',
  category: 'davo_ariza',
  title: L(
    '💔 Маънавий зарар ундириш',
    "💔 Ma'naviy zarar undirish",
    '💔 Взыскание морального вреда',
  ),
  subtitle: L(
    'давлат органи ноқонуний ҳаракатлари оқибатида',
    "davlat organi noqonuniy harakatlari oqibatida",
    'от незаконных действий госоргана',
  ),
  description: L('—', '—', '—'),
  instructions: L(
    `💔 <b>Маънавий зарар ундириш бўйича даъво ариза</b>\n\n📋 <b>Қачон бериш:</b>\nДавлат органи (ИИБ, ЙХХБ, солиқ, божхона ва ҳ.к.) ёки бошқа мансабдор шахс Сизга нисбатан ноқонуний ҳаракатлар содир этган, мисол учун асоссиз жарима солинган, кейинчалик у бекор қилинган. Бундай ҳолатларда содир этилган руҳий, асабий стресс ва шахсий обрўйингизга етказилган зарарни маънавий зарар сифатида ундириш мумкин.\n\n📜 <b>Қонуний асос:</b>\nФуқаролик кодексининг 11, 989, 990 ва 1022-моддалари (жуда ноқонуний ҳаракат натижасида етказилган маънавий зарар учун жавобгарлик).\n\n🏛 <b>Қаерга:</b>\nЖавобгарнинг жойлашган ери ёки даъвогарнинг яшаш жойи бўйича туманлараро фуқаролик судига.\n\n📎 <b>Илова қилинадиган ҳужжатлар:</b>\n• Жарима/постановление қарори нусхаси (агар бўлса)\n• Уни бекор қилган суд қарори нусхаси (агар бўлса)\n• Паспорт нусхаси\n• Давлат божи квитанцияси (ёки уни кечиктириш аризаси)\n• Почта харажати квитанцияси\n• Бошқа далиллар (тиббий справкалар, гувоҳ-номалар)\n\n📝 <b>Бот сўрайди:</b>\nСизнинг маълумотларингиз → жавобгар (давлат органи) номи → иш ҳолатлари (нима бўлди, қачон, қандай ноқонуний ҳаракат) → маънавий зарар тавсифи → талаб қилинаётган сумма → иловалар.`,
    `💔 <b>Ma'naviy zarar undirish bo‘yicha da'vo ariza</b>\n\n📋 <b>Qachon berish:</b>\nDavlat organi (IIB, YXXB, soliq va h.k.) yoki boshqa mansabdor shaxs Sizga nisbatan noqonuniy harakatlar sodir etgan, masalan asossiz jarima solingan, keyinchalik u bekor qilingan. Bunday holatlarda sodir etilgan ruhiy stress va shaxsiy obro‘yingizga yetkazilgan zararni ma'naviy zarar sifatida undirish mumkin.\n\n📜 <b>Qonuniy asos:</b>\nFuqarolik kodeksining 11, 989, 990 va 1022-moddalari.\n\n🏛 <b>Qayerga:</b>\nJavobgarning joylashgan eri yoki da'vogarning yashash joyi bo‘yicha tumanlararo fuqarolik sudiga.\n\n📝 <b>Bot so‘raydi:</b>\nSizning ma'lumotlaringiz → javobgar (davlat organi) nomi → ish holatlari → ma'naviy zarar tavsifi → talab qilinayotgan summa → ilovalar.`,
    `💔 <b>Исковое заявление о взыскании морального вреда</b>\n\n📋 <b>Когда подавать:</b>\nЕсли государственный орган (ОВД, БДД, налоговая, таможня и т. п.) или иное должностное лицо совершило в отношении Вас незаконные действия — например, наложен необоснованный штраф, который впоследствии был отменён. В таких случаях Вы вправе требовать возмещение причинённого душевного, нервного стресса и ущерба деловой репутации в виде морального вреда.\n\n📜 <b>Правовое основание:</b>\nст. 11, 989, 990, 1022 Гражданского кодекса Республики Узбекистан.\n\n🏛 <b>Куда:</b>\nВ межрайонный гражданский суд по месту нахождения ответчика либо по месту жительства истца.\n\n📎 <b>Документы:</b>\n• Копия постановления о штрафе (если есть)\n• Копия судебного решения об его отмене (если есть)\n• Копия паспорта\n• Квитанция о госпошлине (или заявление об отсрочке)\n• Квитанция о почтовых расходах\n• Иные доказательства (медсправки, свидетельские показания)\n\n📝 <b>Бот спросит:</b>\nваши данные → название госоргана-ответчика → обстоятельства дела → описание морального вреда → запрашиваемая сумма → приложения.`,
  ),
  fileNameBase: 'davo-ariza-manaviy-zarar',
  fields: [
    ...APPLICANT_BLOCK,
    F.text(
      'defendant_org_name',
      L(
        '🏛 Жавобгар (давлат органи)',
        '🏛 Javobgar (davlat organi)',
        '🏛 Ответчик (госорган)',
      ),
      L(
        'Масалан: Жиззах вилоят ИИБ ЙХХБ',
        "Masalan: Jizzax viloyat IIB YXXB",
        'Например: ОВД БДД Джизакской области',
      ),
    ),
    NARRATIVE(
      'case_facts',
      L(
        '📝 Иш ҳолатлари (нима бўлди)',
        "📝 Ish holatlari (nima bo‘ldi)",
        '📝 Обстоятельства дела (что произошло)',
      ),
      L(
        'Қачон, қандай ноқонуний жарима солинди, қандай суд кўриб, нима билан тугатилди.',
        "Qachon, qanday noqonuniy jarima solindi, qanday sud ko‘rib, nima bilan tugatildi.",
        'Когда и какой незаконный штраф наложен, как обжалован, чем закончилось.',
      ),
    ),
    NARRATIVE(
      'moral_damage_description',
      L(
        '😔 Етказилган маънавий зарар тавсифи',
        "😔 Yetkazilgan ma'naviy zarar tavsifi",
        '😔 Описание причинённого морального вреда',
      ),
      L(
        'Қанча вақт сарсон бўлдингиз, асабий-руҳий стресс, обрў ва шахсий аҳволингизга таъсири.',
        "Qancha vaqt sarson bo‘ldingiz, asabiy-ruhiy stress, obro‘ va shaxsiy ahvolingizga ta'siri.",
        'Сколько времени мытарства, нервно-психический стресс, влияние на репутацию и личное состояние.',
      ),
    ),
    F.money(
      'damage_amount',
      L(
        '💰 Талаб қилинаётган сумма (сўм)',
        "💰 Talab qilinayotgan summa (so‘m)",
        '💰 Запрашиваемая сумма (сум)',
      ),
    ),
    F.text(
      ...
      L(
        'Масалан: 1) Жарима қарори; 2) Суд қарори; 3) Паспорт нусха; 4) Давлат божи кечиктириш ариза; 5) Почта харажати.',
        "Masalan: 1) Jarima qarori; 2) Sud qarori; 3) Pasport nusxasi; 4) Davlat boji kechiktirish arizasi; 5) Pochta xarajati.",
        'Например: 1) Постановление о штрафе; 2) Решение суда; 3) Копия паспорта; 4) Заявление об отсрочке госпошлины; 5) Почтовые расходы.',
      ),
    ),
  ],
};
